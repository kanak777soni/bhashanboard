...
> **Current corpus snapshot (29 July 2026).** The source corpus contains 45 records: 42 held for evidence review and three withdrawn. No record is live because none yet meets the complete original-language, context, Tier A/B, bounded-video, cleared-needs, and Committee-sign-off bar. The party register contains 22 parties, the refusal ledger contains 18 rulings, and 15 records carry established verbatim quotes. The generated compatibility leaderboard is empty; the database-backed public vote aggregate is the only ranking authority.
